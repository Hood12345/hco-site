// HCOPage.jsx — Full Site with Banner, Modals, All Sections (196 lines)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-900 via-neutral-900 to-zinc-800 text-white font-sans scroll-smooth">
      ...
      <header className="fixed w-full top-0 left-0 bg-zinc-900 z-50 shadow-md">
        <div className="max-w-7xl mx-auto flex items-center justify-between pl-4 pr-6 py-4">
          <a href="/" className="flex items-center ml-0">
            <img src="/hood.png" alt="HCO Logo" className="h-10 w-auto object-contain" />
          </a>
          ...
          <div className="md:hidden"><Menu className="text-white w-6 h-6" /></div>
        </div>
      </header>
      ...
      <section className="relative flex flex-col items-center justify-center text-center py-40 px-4 overflow-hidden bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-zinc-900 via-black to-zinc-800">
        <div className="absolute inset-0 bg-[radial-gradient(circle,rgba(255,255,255,0.05),transparent_70%)] animate-pulse" />
        <img src="/hood.png" alt="HoodClipsOfficials Logo" className="md:h-[12rem] h-[9rem] w-auto z-10 drop-shadow-[0_4px_20px_rgba(255,0,0,0.4)]" />
        <p className="mt-8 text-2xl text-gray-300 max-w-2xl z-10">We’re experts in algorithm comprehension and viral momentum — engineering content that breaks the feed.</p>
        <div className="mt-10 flex flex-col md:flex-row gap-6 z-10">
          <button className="bg-gradient-to-br from-red-600 to-red-400 text-white px-10 py-4 text-lg rounded-2xl shadow-2xl hover:shadow-red-500/50 transform transition hover:scale-105 active:scale-95" onClick={() => setShowBrandForm(true)}>Work With Us</button>
          <button className="bg-gradient-to-br from-white to-gray-200 text-black px-10 py-4 text-lg rounded-2xl shadow-2xl hover:shadow-white/50 transform transition hover:scale-105 active:scale-95" onClick={() => setShowSubmitForm(true)}>Submit Your Clip</button>
        </div>
        <div className="absolute w-full h-full top-0 left-0 backdrop-blur-md z-0" style={{ mixBlendMode: 'overlay' }} />
      </section>
      ...
      <section className="overflow-hidden bg-zinc-800 py-6 border-y border-zinc-700">
        <div className="animate-marquee whitespace-nowrap text-center">
          {[...Array(3)].map((_, i) => (
            <span key={i} className="text-white font-semibold text-sm mx-8">Partnered with <span className="text-red-500">HCO INC.</span></span>
          ))}
        </div>
      </section>
      ...
      <section className="py-32 px-6 text-center bg-gradient-to-tr from-zinc-900 via-zinc-800 to-neutral-900">
        ...
        <p className="text-lg text-gray-300 max-w-3xl mx-auto">@hoodclipsofficials curates the internet’s most viral clips — spotlighting culture, chaos, and creators. We don’t just follow trends. We ignite them.</p>
        <div className="mt-16 grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="bg-gradient-to-br from-zinc-900 to-neutral-800 rounded-3xl p-6 shadow-2xl hover:shadow-red-500/50 hover:scale-105 transition">
      ...
      <section className="py-32 px-6 bg-gradient-to-br from-zinc-900 via-neutral-900 to-zinc-800 text-center">
        ...
        <p className="text-lg text-gray-300 max-w-2xl mx-auto mb-10">We deliver scroll‑stopping content, speed, and cultural relevance. Our creative team moves faster than trends — delivering campaigns that matter.</p>
        <div className="grid md:grid-cols-2 gap-10 max-w-4xl mx-auto">
          {[
            ...
            <div key={i} className="bg-gradient-to-br from-zinc-800 to-neutral-800 p-6 rounded-2xl shadow-2xl hover:shadow-red-500/50 hover:scale-105 transition">
      ...
      <section className="bg-zinc-950 py-20 px-6 text-white shadow-inner">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            ...
            <p className="text-sm text-gray-400">Hoodclipsofficials is a next‑gen media company fueling digital culture. We blend AI‑assisted virality with community‑driven content to redefine online entertainment.</p>
          </div>
          <div>
      ...
      <div className="bg-zinc-950 text-center text-xs text-gray-500 py-4">© {new Date().getFullYear()} Hoodclipsofficials. All rights reserved.</div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-70 z-50 flex items-center justify-center px-4">
          <div className="bg-zinc-900 p-8 rounded-2xl max-w-lg w-full relative shadow-2xl">
            ...
            <form className="space-y-4">
              ...
              <textarea placeholder="Tell us about your project" className="w-full p-3 h-32 rounded-lg bg-zinc-800 text-white placeholder-gray-400" />
      ...
      {showSubmitForm && (
        <div className="fixed inset-0 bg-black bg-opacity-70 z-50 flex items-center justify-center px-4">
          <div className="bg-zinc-900 p-8 rounded-2xl max-w-lg w-full relative shadow-2xl overflow-y-auto max-h-[90vh]">
            ...
            <form className="space-y-4">
              ...
              <input type="file" accept="video/*" className="w-full p-3 rounded-lg bg-zinc-800 text-white" />
              ...
              {showDescription && (
                <textarea placeholder="Tell us about your clip" className="w-full p-3 h-24 rounded-lg bg-zinc-800 text-white placeholder-gray-400" />
              )}
